-- ==========================================
-- TUẤN THỢ SĂN - ULTIMATE VIP HUB (EMERGENCY STOP)
-- ==========================================
...
local Window = Rayfield:CreateWindow({
   ...
   LoadingSubtitle = "Bản Tự Động & Nút Thoát Khẩn Cấp",
...
Rayfield:Notify({Title = "Tuấn Thợ Săn", Content = "Đã thêm nút Thoát Khẩn Cấp thành công!", Duration = 3})
        if autoBid then 
            task.spawn(function() 
