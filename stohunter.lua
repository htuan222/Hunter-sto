...
local Window = Rayfield:CreateWindow({
   Name = "Ultimate Farm Hub v14.1",
   LoadingTitle = "Đang tải giao diện...",
   LoadingSubtitle = "Đã fix hiển thị đầy đủ các Tab...",
...
ConfigTab:CreateButton({
   ...
   Callback = function()
       ...
       local scriptContent = '-- Auto Execute generated by Ultimate Farm Hub\n' ..
                             'task.spawn(function()\n' ..
                             '    pcall(function()\n' ..
                             '        print("Ultimate Farm Hub: Auto Execute Loaded Config: ' .. selectedConfigToLoad .. '")\n' ..
                             '    end)\n' ..
                             'end)'
